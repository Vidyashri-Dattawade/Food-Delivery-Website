...
let total =Math.floor(subtotal+deliveryFree+taxes)
  ...
  return (
    <div className='bg-slate-100 w-full min-h-screen'> 
      ...
      w-[100%]'>
        {categories.map((item)=>{
         return <div className='w-[140px] h-[150px] bg-white flex flex-col items-start gap-5 p-5 justify-start 
         text-[20px] font-semibold text-gray-600 rounded-lg shadow-xl hover:bg-green-200
      ...
      <div className={`w-full md:w-[40vw] h-[100%] fixed top-0 right-0 bg-white shadow-xl p-6 transition-all duration-500 
        ...
        <header className='w-[100%] flex justify-between items-center'>
          ...
          <RxCross2 className='w-[30px] [h-30px] text-green-400 text-[18px] font-semibold 
        ...
        <div className='w-full border-t-2 border-b-2 border-gray-400 mt-7 flex flex-col gap-2 p-8'>
              <div className='w-full flex justify-between items-center'>
               ...
               <div className='w-full flex justify-between items-center'>
                <span className='text-lg text-gray-600 font-semibold'>Delivery Free</span>
             ...
             <div className='w-full flex justify-between items-center p-9'>
              ...
              <button className='w-[80%] p-3 bg-green-500 rounded-lg text-white
               hover:bg-green-400 transition-all'onClick={()=>{
